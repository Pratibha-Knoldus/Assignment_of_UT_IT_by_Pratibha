...
//Integration testing for the methods of UserValidation class
  ...
  val user2 : User = User("Suresh","Yadav",21,50000,"Engineer","Knoldus","pratibhayadav@knoldus.com")
  ...
  val user5 : User = User("Suresh","Yadav",21,50000,"Engineer","Google","pratibhayadavknoldus.com")
